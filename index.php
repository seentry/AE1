...
$palabras = ['elefante', 'jirafa', 'hipopotamo', 'rinoceronte', 'cocodrilo', 'camello', 'chimpance', 'leon', 'tigre', 'pantera', 'cebra'];
...
<body>
    <div class="container">
        ...
        <p class="vidas">Vidas restantes: <?php echo $_SESSION['vidas']; ?></p>
        <form method="post">
            <label for="letra">Introduce una letra:</label>
            <input type="text" name="letra" id="letra" maxlength="1" required>
            <button type="submit">Adivinar</button>
        </form>
        <p class="used-letters">Letras usadas: <?php echo implode(', ', $_SESSION['letras_usadas']); ?></p>
    </div>
</body>
</html>
